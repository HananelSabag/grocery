...
export default {
  ...
  share: {
    ...grocery.share,
    // שיתוף הוא קישור, ורק קישור: שולחים או מעתיקים. בלי קוד על המסך.
    send: 'שליחת הקישור',
    copyLink: 'העתקת קישור',
    linkHint: 'כל מי שמקבל את הקישור יכול להצטרף לרשימה. הקישור קבוע — הוא עובד גם בקבוצה וגם בעוד חודש.',
    message: 'הצטרפו לרשימת הקניות שלנו',
    messageNamed: 'הצטרפו לרשימת הקניות שלנו: {{name}}',
    replaceLink: 'החלפת קישור',
    replaceLinkConfirm: 'כן, להחליף',
    replaceLinkWarning: 'הקישור הנוכחי יפסיק לעבוד, גם אצל מי שכבר קיבל אותו. מי שכבר ברשימה נשאר בה.',
